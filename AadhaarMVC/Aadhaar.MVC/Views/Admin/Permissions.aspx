<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Aadhaar.MVC.Models.Permissions>" %>
...
{%>
    <tr>
        ...
        { %><%=Html.Hidden("hdnPermId", item.Id) %><button name="DeletePerm" value="DeletePerm"  onclick="return confirm('This Action will be deleted. Are you sure you wish to proceed for deletion?');">Delete</button>
         <%} %>
...
<tr><th colspan="4">Existing Controllers</th></tr>
    ...
    <th>
        ...
        {%>
         ...
         { %><%=Html.Hidden("hdnActionId", item.Id)%> <button name="DeleteAction" value="DeleteAction" onclick="return confirm('This Action will be deleted. Are you sure you wish to proceed for deletion?');">Delete</button></td>
        <% }%></tr>
       <%} %> 
        </table>
