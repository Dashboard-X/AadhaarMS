    ...
    public class ADHPermissionsModule : IHttpModule
    {
        ...
        public void CheckPermissions(object sender, EventArgs args)
        {
            ...
            if (HttpContext.Current.User.Identity.IsAuthenticated)
            {
                ...
                string[] permissions = Aadhaar.Data.ADHSecurityHelper.GetRolesForControllerAction(HttpContext.Current.User.Identity.Name, out HasUserPermission,reqFolder, reqFile);
